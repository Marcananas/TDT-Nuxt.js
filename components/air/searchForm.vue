  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          this.$store.commit("air/setAirInfo", this.form);
          this.$router.push(
            `/air/flights?departCity=${this.form.departCity}&departCode=${this.form.departCode}&destCity=${this.form.destCity}&destCode=${this.form.destCode}&departDate=${this.form.departDate}`
          );
        }
      });
    }
